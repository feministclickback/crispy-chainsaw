...
<p>Dafür liefert der untenstehende Text Hintergrundinformationen und praktische Anleitungen.</p>
...
<p>Die ‣Bots bewegen sich unermüdlich durch das Internet, indem sie Links folgen, die sie von einer Seite zur nächsten bringen. Webseiten, die sie relevant finden, landen in einer Datenbank. Sobald die ‣Bots eine Seite gefunden haben, entziffern sie deren ‣Quelltext, versuchen den Inhalt zu verstehen und entscheiden, für welche Suchbegriffe sie relevant ist. Dieser Vorgang nennt sich ‣indexing, vom englischen Verb to index (katalogisieren), und eine solche Datenbank wird ‣Index genannt. Diese Datenbanken sind riesig (über 100 Millionen GB) und werden in großen Rechenzentren überall auf der Welt gespeichert. Dadurch, dass sie das Netz auf diese Weise schon vorsortiert haben, können Suchmaschinen gewährleisten, dass es nur Millisekunden dauert, bis sie auf eine Suchanfrage eine Antwort parat haben.</p>
<p>Die wichtigsten ‣Ranking-Faktoren, die bestimmen, welche Seite auf den ersten, zweiten, dritten usw. Platz kommt, sind Relevanz und Popularität. Die Suchmaschinen versuchen also nicht nur zu verstehen, worum es auf einer Seite geht (Relevanz), sondern auch, wie sich Besucher*innen auf der Seite verhalten, und ziehen aus diesen sogenannten ‣User-Signalen Rückschlüsse darauf, ob sie dort das finden, wonach sie gesucht haben (Popularität).</p>
...
<p>Dennoch gibt es einige Methoden, die sich bewährt haben. Je größer die Konkurrenz um einen bestimmten Suchbegriff ist, desto aufwändiger ist das Unterfangen. In diesem Kapitel geht es jedoch noch nicht um die praktische Umsetzung, sondern zunächst einmal nur um die grundlegenden Prinzipien, die für das Verständnis von SEO wichtig sind. Listen zum Abarbeiten gibt es dann weiter unten im praktischen Teil.</p>
...
<p>Durch eine solche Struktur ist für die Suchmaschinen klar erkennbar, welche Inhalte sich auf welchen Seiten befinden. Diese Struktur sollte sich im Aufbau der Webseite klar widerspiegeln. Die wichtigsten Unterseiten sollten in der Hauptnavigation verlinkt sein. Links zu den Unterthemen sollten hingegen sollten auf den Seiten ihrer jeweiligen Oberthemen zu finden sein und ansonsten nur dort, wo es inhaltlich für die Nutzer*innen ausdrücklich Sinn ergibt.</p>
...
<p>Wichtig sind auch Titel und Beschreibung der Seite (in der Broschüre ‣title und ‣description genannt, weil im SEO-Kontext meist nur die englischen Begriffe verwendet werden). ‣Title und ‣description sind auf der Seite nicht sichtbar, sondern stehen im ‣Quelltext und treten nur in den Suchergebnissen zutage:</p>
...
<p>Neue Webseiten haben es zudem deutlich schwerer als solche, die schon länger existieren. Wenn es nicht auf Anhieb gelingt, für stark umkämpfte Suchbegriffe auf der ersten Seite zu erscheinen, ist das noch kein Grund zur Besorgnis. Stattdessen sind in dem Fall ein langer Atem und etwas Geduld nötig.</p>
<h2 id="politischer-hintergrund">POLITISCHER HINTERGRUND</h2>
...
<p class="box"><strong>Die scheinbare Neutralität von Algorithmen</strong><br>Bei alldem ist nicht zu vergessen, dass der Kampf um Suchmaschinenplatzierungen nicht auf einem neutralen Spielfeld stattfindet. Wer die Regeln kennt, kann zwar viel erreichen. Doch letzten Endes entscheidet Google, wer gewinnt. Und die Kriterien, nach denen Google dies tut, sind nicht neutral, auch wenn das Unternehmen dies gerne behauptet.<br>Zum Beispiel spielt der sogenannte Brand-Faktor (Marken-Faktor) eine wichtige Rolle: Je bekannter und einflussreicher eine Marke ist, desto wahrscheinlicher wird deren Webseite in den Suchergebnissen weiter oben platziert, und dies unabhängig davon, wie gut deren Webseite SEO-optimiert ist. Dadurch trägt Google zur Stabilisierung (kapitalistischer) Machtverhältnisse bei.<br>Seiten mit menschenfeindlichen Inhalten zu listen, ist ebenfalls eine politische Entscheidung, die sich lediglich hinter der Behauptung von Neutralität verbirgt.</p>
<h3>SEO als gezielte Strategie von Lebensschützern</h3>
<p>An Struktur und Aufbau einschlägiger „Lebensschutz“-Webseiten ist erkennbar, dass sie SEO gezielt betreiben und das auch relativ erfolgreich: Für ‣Keywords wie „Abtreibung“ und verwandte Suchanfragen wie „Abtreibung Deutschland“ erscheinen „Lebensschutz“-Seiten auf der ersten Seite. Feministische Organisationen wie <a href="https://www.profamilia.de/">Pro Familia</a> befinden sich weit hinten.</p>
<p>Wie ein <a href="http://www.nytimes.com/2013/01/05/health/pregnancy-centers-gain-influence-in-anti-abortion-fight.html">Artikel</a> der New York Times beschreibt, ist SEO für die ‣Anti-Choice-Bewegung1 in den USA schon längst ein wichtiges Werkzeug geworden. Dadurch schaffen sie es erstens, eine viel größere Anzahl an Menschen zu erreichen, zweitens verdrängen sie damit feministische Webseiten nach hinten (SEO basiert schließlich auf Konkurrenz), und drittens schließlich umgehen sie so staatliche Verbote (etwa wenn es ihnen untersagt ist, Schwangere direkt vor Kliniken auf dem Gehsteig anzusprechen) und entziehen sich feministischem Protest.</p>
<p class="fussnote"><span>[</span><span>[</span>&nbsp;Die Anti-Choice-Bewegung ist das US-amerikanische Pendant zur deutschen „Lebensschutz“-Bewegung. „Anti-Choice“ ist ein Begriff, den Feminist*innen geprägt haben, um nicht die irreführende Selbstbezeichnung der Abtreibungsgegner*innen („Pro-Life“) zu verwenden.  Teilweise sprechen Feminist*innen in Deutschland auch von „Anti-Choice“ statt „Lebensschutz“.&nbsp;<span>]</span><span>]</span></p>
<p>Diese Strategie ist besonders heimtückisch, weil zu vermuten ist, dass Schwangere, die einen Schwangerschaftsabbruch erwägen, besonders häufig das Internet für Informationen nutzen. Zumal Schwangerschaftsabbrüche in manchen Teilen der Bevölkerung noch so stigmatisiert sind, dass es womöglich im direkten Umfeld keine Bezugspersonen gibt, mit denen sie über ihre Situation offen reden könnten. Um diese Lage auszunutzen, bieten viele „Lebenschutz“-Webseiten Telefon-Hotlines an, die vordergründig Rat und Hilfe anbieten, tatsächlich jedoch die Anrufer*innen von einem möglichen Schwangerschaftsabbruch abhalten sollen. Das sollte nicht unwidersprochen bleiben!</p>
</div>
<div class="gruen">
...
<p class="box"><strong>Die richtigen Worte finden: </strong>Es gehört zu feministischer Bewegung dazu, Herrschaft auch in der Sprache aufzudecken und anzugreifen. Dazu gehört es, neue Wörter zu finden, um herrschaftsförmige Begriffe zu ersetzen. Aus der Perspektive von SEO kann dies jedoch problematisch sein, weil diese Wortneuschöpfungen oft noch nicht allgemein geläufig sind und deshalb auch nur von wenigen Menschen gesucht werden. Bis feministische Sprache in der Mehrheitsgesellschaft angekommen ist, kann es deshalb Sinn machen, zweigleisig zu fahren: Das bedeutet, Begriffe zu verwenden, die die Menschen googeln, im Text jedoch auf die Problematik hinzuweisen und die jeweils eigene Begriffswahl für Leser*innen nachvollziehbar zu erläutern.</p>

<h4>3. Nutzt Recherche-Tools</h4>

<p>Folgende kostenlose Tools können euch bei der Suche nach passenden ‣Keywords helfen. Beginnt mit einem allgemeinen Oberbegriff, den ihr schon habt. Die Tools machen euch dann Vorschläge auf Basis von Google-Daten. (Achtung: Anmeldung mit E-Mail-Adresse z.T. erforderlich, Anzahl an Abfragen pro Tag sind in der kostenlosen Variante meist begrenzt)</p>
...
<p>Ermittelt für alle ‣Keyword-Ideen, die ihr bisher gesammelt habt, das durchschnittliche monatliche ‣Suchvolumen bei Google. Leider gibt es zur Zeit kein gutes kostenloses Tool dafür. Bei bestehenden Tools ist in der kostenlosen Variante meist die Anzahl an Anfragen pro Tag stark begrenzt. Darüber hinaus ist oft eine Registrierung mit E-Mail-Adresse nötig. Deshalb lohnt es sich, mehrere  Tools parallel zu nutzen, z.B. <a href="http://www.keyword-tools.org/recherche/">http://www.keyword-tools.org/recherche/</a>, <a href="https://moz.com/explorer">Moz Keyword Explorer</a> oder <a href="https://app.kwfinder.com">KW Finder</a>. Bei KW Finder ist es übrigens möglich, eine Liste an bis zu 200 Keywords hochzuladen, die dann bei einer Anfrage gleichzeitig abgefragt werden. Achtet darauf, dass ihr das richtige Land eingestellt habt (es ist auch möglich, für nicht-deutschsprachige Begriffe das jeweilige ‣Suchvolumen in Deutschland herauszufinden).</p>
<h4>5. Trefft eine Auswahl</h4>
<p>Nun könnt ihr die Liste, die ihr als Ergebnis vor euch liegen habt, auswerten. Welche ‣Keywords haben das meiste ‣Suchvolumen? Welche Themen scheinen die Menschen am meisten zu beschäftigen? Passt die ‣Suchintention hinter den Suchbegriffen zu euren Zielen? (Tipp: Die ‣Suchintention könnt ihr ungefähr abschätzen, indem ihr den Begriff über das Tool impersonal.me googelt und euch die Suchergebnisse auf der ersten Seite anschaut.) Trefft anhand dieser Überlegungen eine Auswahl an ‣Keywords, auf die ihr optimieren wollt. Beachtet dabei, dass ein niedriges ‣Suchvolumen nicht immer schlecht sein muss. Es sollte zwar nicht so niedrig sein, dass es den Aufwand nicht lohnt; aber solange die ‣Suchintention dahinter gut zu euren Zielen passt, sind auch diese Begriffe wertvoll, zumal mensch für sie meistens schneller gute Ergebnisse erreichen kann.</p>
...
<p>Nehmt nun die ‣Keywords, die ihr ausgewählt habt, und nehmt sie zur Grundlage für den Aufbau eurer Seite. Jedes ‣Keyword bekommt eine eigene ‣URL, es sei denn, die ‣Keywords sind sich so ähnlich, dass wahrscheinlich die gleiche ‣Suchintention dahinter steckt, dann können sie auch von einer ‣URL abgedeckt werden (in dem Fall wäre dann das Keyword mit dem meisten ‣Suchvolumen das Haupt-Keyword und alle weiteren ‣Keywords mit der gleichen ‣Suchintention, aber weniger ‣Suchvolumen sind Neben-‣Keywords). Macht euch davon am besten eine Liste zur besseren Übersicht.</p>
...
<h4>An diesen Stellen sollte das Haupt-Keyword vorkommen:</h4>
<ul class="char">
...
<li><span>Erstellt ggf. Social-Media-Accounts und pflegt diese. Achtet darauf, dass ihr eure eigenen Bilder, Videos etc. nicht einfach so teilt – im Idealfall habt ihr alle Medien auch auf eurer Webseite und könnt den Link immer mit verbreiten. Auf diese Weise wissen alle sofort, wo sie die Quelle finden können.</span></li>
...
<ul class="char">
<li><span> Die wichtigsten Unterseiten sind insgesamt am häufigsten verlinkt.</span></li>
<li><span> Von der Startseite aus kommt mensch mit möglichst wenigen Klicks zu den wichtigsten Seiten – je wichtiger die Seite, desto weniger Klicks sind nötig, um sie zu erreichen (vom Allgemeinen ins Detail).</span></li>
<li><span> In Navigationsleisten und in der Fußleiste befinden sich nur wenige Links (nur die Wichtigsten).</span></li>
<li><span> Unterseiten zu einem Unterthema sind untereinander häufiger verlinkt, wobei es eine Hauptseite geben sollte, die am häufigsten verlinkt ist.</span></li>
...
<p>Um zu erreichen, dass Besucher*innen mit der Seite interagieren, müssen in erster Linie die Inhalte gut und die Seite übersichtlich und ansprechend aufgebaut sein – das reicht im Idealfall schon aus. Es gibt aber einige einfache Mittel, um die Interaktion zu fördern, die gleichzeitig den positiven Nebeneffekt haben, dass sie das Nutzungserlebnis generell verbessern.</p>
<h4>Dazu gehören:</h4>
<div class="liste-mittig">
<ul>
...
<p>Bestehende Webseiten in Hinblick auf SEO zu überarbeiten bedeutet oft eine Menge Arbeit, v.a. wenn Aufbau und ‣URL-Struktur geändert werden müssen. Um dies zu erleichtern und Fehlerquellen zu vermeiden, gibt es im Folgenden einige Tipps.</p>
